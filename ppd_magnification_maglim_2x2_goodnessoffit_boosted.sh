...
export RUNNAME=magnification_maglim_2x2pt_lcdm_freemag
...
export VALUESINCLUDE=magnification/values_maglim_freemag.ini
export PRIORSINCLUDE=maglim/priors.ini

export OMP_NUM_THREADS=2

cd ..
srun -n ${SLURM_NTASKS} cosmosis --mpi ppd/magnification_maglim_2x2_goodnessoffit/ppd.ini -p listppd.size_chunk=1000 listppd.i_chunk=${SLURM_ARRAY_TASK_ID} output.filename=ppd/maglim_2x2_goodnessoffit/ppd_chain_${RUNNAME}_magnification_maglim_2x2_goodnessoffit_${SLURM_ARRAY_TASK_ID}.txt
cd ppd
